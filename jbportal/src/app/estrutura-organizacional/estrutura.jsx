      ...
      <div className="bg-white py-16 w-full">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-8">
              <a href="https://seulink.com">
                <div className="bg-[#002A66] text-white w-[90%] sm:w-[300px] h-[200px] mx-auto flex flex-col justify-center items-center shadow-lg hover:bg-gradient-to-br hover:from-[#002A66] hover:to-[#377BB5] hover:text-white group overflow-hidden transition-all duration-500 ease-in-out relative">
                  ...
                  {/* Novo texto que aparece ao hover */}
                  <span className="hidden group-hover:flex justify-center items-center absolute inset-0 text-[20px] font-semibold transition-opacity duration-500 ease-in-out group-hover:opacity-100">
                      INSTITUCIONAL
                  </span>
                </div>
