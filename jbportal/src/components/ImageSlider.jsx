...
export default function ImageSlider() {
  ...
  return (
    <div className="carousel-container  relative my-">
      ...
      <section className="absolute top-60 left-0 w-full h-full flex justify-around items-center p-4 bg-opacity-75 z-10">
        ...
        <a href="#convenios" className="flex flex-col items-center m-2 border-r border-white pr-4 transition-transform transform hover:translate-y-[-10px]">
          ...
          <p className={`${roboto.variable} mt-1 text-xs text-white text-center w-full max-w-xs`}>CONVÊNIOS,<br />EMENDAS E OUTROS REPASSES</p>
        </a>
        <a href="#planejamento" className="flex flex-col items-center m-2 border-r border-white pr-4 transition-transform transform hover:translate-y-[-10px]">
          ...
          <p className={`${roboto.variable} mt-1 text-xs text-white text-center w-full max-w-xs`}>PLANEJAMENTO<br />E GESTÃO FISCAL</p>
        </a>
        <a href="#transparencia" className="flex flex-col items-center m-2 border-r border-white pr-4 transition-transform transform hover:translate-y-[-10px]">
          ...
          <p className={`${roboto.variable} mt-1 text-xs text-white text-center w-full max-w-xs`}>MAIS<br />TRANSPARÊNCIA</p>
        </a>
        <a href="#governanca" className="flex flex-col items-center m-2 border-r border-white pr-4 transition-transform transform hover:translate-y-[-10px]">
          ...
          <p className={`${roboto.variable} mt-1 text-xs text-white text-center w-full max-w-xs`}>GOVERNANÇA DE DADOS<br />E TRANSPARÊNCIA</p>
        </a>
        <a href="#pesquisa" className="flex flex-col items-center m-2 border-r border-white pr-4 transition-transform transform hover:translate-y-[-10px]">
          ...
          <p className={`${roboto.variable} mt-1 text-xs text-white text-center w-full max-w-xs`}>PESQUISA DE<br />SATISFAÇÃO</p>
        </a>
        ...
        <a href="#radar" className="flex flex-col items-center m-2 transition-transform transform hover:translate-y-[-10px]">
          ...
          <p className={`${roboto.variable} mt-1 text-xs text-white text-center w-full max-w-xs`}>Radar da Transparência Pública</p>
        </a>
      </section>
      <BorderTop />
    </div>
